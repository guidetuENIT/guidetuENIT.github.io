...
### 5.1.2. Configurer un logiciel de messagerie
#### 5.1.2.1. Thunderbird
...
## 5.2. Emploi du temps : hyperplanning
...
### 5.2.1. Récupérer le lien dans hyperplanning
...
#### 5.2.2.2. Google Agenda (pour téléphone Android)
...
- Dans la fenêtre apparue, coller l'adresse copiée depuis hyperplanning.net(paragraphe 5.2.1.)
- Cliquer sur "Ajouter un agenda"
![googleagenda](images\googleagenda.png)

#### 5.2.2.3. Calendrier (MacOS)
- Ouvrir calendrier</li>
...
## 5.3. Consultation de votre dossier personnel
...
## 5.4. Réservation de salles de projet
...
## 5.5. Plateforme d'enseignement à distance : Moodle
...
## 5.6. Travailler sur ordinateur à l'ENIT
L’ENIT dispose de 5 salles « Informatique » équipées de postes permettant de travailler sur des machines virtuelles, disposant des logiciels nécessaires aux enseignements ayant lieu dans ces salles (plan p7). Les documents et fichiers que vous manipulez et créez sur ces machines virtuelles sont stockés dans votre dossier personnel (voir §0 p21). Les salles info1 à info4 sont accessibles (accès par carte) lorsqu’il n’y a pas d’enseignement qui s’y déroule (voir EDT des salles sur planning.enit.fr et des salles info sur la porte d’info1).  
...
L’ENIT dispose aussi de 7 salles de bureau d’études, équipées de PC (voir §5.6.6).  
Enfin, l’ENIT propose à ses étudiants et à son personnel un service de stockage et de partage de fichiers locaux et en ligne (un cloud (voir §5.6.5).
...
#### 5.6.5.1 Synchronisation Nextcloud/répertoire local
...
### 5.6.6. Salles Bureau d'études (salles BE)
...
#### Pour sauvegarder vos documents de travail en salles BE, utilisez les moyens suivants :
		- Votre espace Nextcloud (voir §5.6.5)
		- espace des machine virtuelles des salles info (voir §5.6.4)
